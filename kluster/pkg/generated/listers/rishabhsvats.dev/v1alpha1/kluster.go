...
type KlusterLister interface {
	...
	List(selector labels.Selector) (ret []*rishabhsvatsdevv1alpha1.Kluster, err error)
...
type klusterLister struct {
	listers.ResourceIndexer[*rishabhsvatsdevv1alpha1.Kluster]
}

// NewKlusterLister returns a new KlusterLister.
func NewKlusterLister(indexer cache.Indexer) KlusterLister {
	return &klusterLister{listers.New[*rishabhsvatsdevv1alpha1.Kluster](indexer, rishabhsvatsdevv1alpha1.Resource("kluster"))}
}

// Klusters returns an object that can list and get Klusters.
func (s *klusterLister) Klusters(namespace string) KlusterNamespaceLister {
	return klusterNamespaceLister{listers.NewNamespaced[*rishabhsvatsdevv1alpha1.Kluster](s.ResourceIndexer, namespace)}
}
...
type KlusterNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*rishabhsvatsdevv1alpha1.Kluster, error)
